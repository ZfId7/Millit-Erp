# File path: modules/machining/routes/machines.py
...
from modules.machining.services.machine_service import (
    get_machine_by_id,
    get_machine_queue,
    get_machine_by_key,
)
...
def mfg_machines_index():
    ...
    return render_template("manufacturing/machines.html", machines=machines)
...
def mfg_machine_detail(machine_id):
    ...
    return render_template("manufacturing/machine_detail.html", machine=machine, queue=queue)
