# File path: modules/manufacturing/machining/routes/details.py

from flask import render_template, flash, redirect, url_for
from .. import mfg_bp
from modules.user.decorators import login_required
from database.models import BuildOperation, BuildOperationProgress
from modules.manufacturing.machining.services.progress_service import get_op_totals
